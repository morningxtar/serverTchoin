...
public class Prestation implements Serializable {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof Prestation)) {
         return false;
      } else {
         Prestation other = (Prestation)o;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof Prestation;
   }
   ...
   public Prestation(final Long id, final String libelle, final double prix) {
      this.id = id;
      this.libelle = libelle;
      this.prix = prix;
   }
   ...
   public String toString() {
      return "Prestation(id=" + this.getId() + ", libelle=" + this.getLibelle() + ", prix=" + this.getPrix() + ")";
   }
}
